...
def project_pti(
    ...
    for step in pbar:
        ...
        for i in target_indices:
            synth_images = G.synthesis(w_pivot, c=images[i].c, noise_mode='const')['image']
        ...
        if step == num_steps - 1 or step % 25 == 0:
            for i in target_indices:
                ...
                with torch.no_grad():
                    synth_image = G.synthesis(w_pivot, c=images[i].c, noise_mode='const')['image']
